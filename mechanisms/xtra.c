...
#define sine_freq sine_freq_xtra
 double sine_freq = 1000;
...
static void _modl_cleanup(){ _match_recurse=1;}
 ...
 static void _ba1(Node*_nd, double* _pp, Datum* _ppd, Datum* _thread, NrnThread* _nt)  {
    _p = _pp; _ppvar = _ppd;
  v = NODEV(_nd);
 ex = stim * sin ( 2.0 * PI * sine_freq * t ) * es ;
   }
...
static const char* nmodl_file_text = 
  ...
  "	sine_freq = 1000 : added, this frequency needs to be changed\n"
  "}\n"
  "\n"
  "ASSIGNED {\n"
  "	v (millivolts)\n"
  ...
  "INITIAL {\n"
  "	:ex = stim*es : original\n"
  "	ex = stim*sin(2*PI*sine_freq*t)*es : added\n"
  "}\n"
  "\n"
  "\n"
